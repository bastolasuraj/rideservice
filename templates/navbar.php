...
<!--            <span class="title has-text-white">Ride Service Tracker</span>-->
...
<!--        --><?php //if (isset($_SESSION['username'])): ?>
<!--            <div class="navbar-item">-->
<!--                <button class="button is-light" id="logoutBtn"><a href="logout.php">Logout</a></button>-->
<!--            </div>-->
<!---->
<!--        --><?php //else: ?>
<!--            <div class="navbar-item">-->
<!--                <button class="button is-light" id="logoutBtn"><a href="login.php">Log in</a></button>-->
<!--            </div>-->
<!--        --><?php //endif; ?>
<!--    </div>-->
<!--</nav>-->
